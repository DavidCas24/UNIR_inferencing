...
#ifndef tflite_anomaly_4_GEN_H
#define tflite_anomaly_4_GEN_H
...
TfLiteStatus tflite_anomaly_4_reset( void (*free)(void* ptr) );


// Returns the number of input tensors.
inline size_t tflite_anomaly_4_inputs() {
  return 1;
}
// Returns the number of output tensors.
inline size_t tflite_anomaly_4_outputs() {
  return 1;
}
